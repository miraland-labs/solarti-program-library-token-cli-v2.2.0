...
The Solarti Program Library (SPL) is forked and derived from the Solana Program Library.
Based on release: SPL Token CLI - v2.2.0
This fork are mainly for Token Client(spl-token) v2.2.0 and Memo(spl-memo) v0.2.2
